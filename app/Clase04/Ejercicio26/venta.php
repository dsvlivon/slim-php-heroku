...
{   
    ...
    public function _Vender($aUsuarios, $aProductos)
    {
        ...
        $listaVentas = venta::_CargaListaJSON("ventas.json");
        $listaUsuarios = usuario::_CargaListaJSON($aUsuarios);
        $listaProductos = producto::_CargarListaJSON($aProductos);

        $flag = usuario::_VerificarUsuarioPorId($this->_idUsuario,$listaUsuarios);
